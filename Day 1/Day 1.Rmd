...
```{r, warning=FALSE}
setwd("C:/Users/raymo/Documents/Fall 2024/MUSA6310 Communication/30 Days Mapping Challenge/Day 1")
```

```{r}
parks <- read.csv("C:/Users/raymo/Documents/Fall 2024/MUSA6310 Communication/30 Days Mapping Challenge/Day 1/data/parks.csv")
```
...
ggplot() +
  ...
  labs(title = "National Parks in the United States (CONUS)",
